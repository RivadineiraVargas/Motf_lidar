# GENERADO por run_noclip_cv.sh — dec del fold 3, protocolo VIGENTE.
# Igual a f1cv_dec_fold3 pero SIN el recorte del objetivo (clip_norm=None) y con
...
# GENERADO por run_fase1_cv.sh — decoder (dec) del fold 3.
...
work_dir = './work_dirs/noclipcv/noclip_dec_fold3'
load_from = './work_dirs/f1cv/mae_encoder_fold3.pth'
