# config_rangeview_rect_fold2.py — Re-pre-entrenamiento del encoder MAE SOLO
# en las 20 escenas de TRAIN del fold 2 (sin fuga de las 5 retenidas).
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CustomDataset',
        data_root='/home/lcad/lidar_sweep_viewer/waymo_clean/range_png_rect/fold2_train',
        with_label=False,
...
work_dir = './work_dirs/rv_rect_fold2'
