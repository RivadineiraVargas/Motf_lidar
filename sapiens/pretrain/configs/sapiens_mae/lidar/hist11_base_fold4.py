# hist11_base_fold4.py — el baseline cinemático con la historia COMPLETA.
#
# Copia de noclip_base_fold4.py con history_len 5 -> 11. Es el único
...
work_dir   = './work_dirs/hist11/base11_fold4'
