...
model = dict(
    ...
    use_gate=True,
    gate_init=0.5,
    predict_uncertainty=True,   # media + varianza (NLL), incerteza por pose   # rompe el candado: arranca usando la escena a medias
)
...
work_dir = './work_dirs/clean10_gated_uncert'
load_from = './work_dirs/mae_encoder_clean10.pth'
