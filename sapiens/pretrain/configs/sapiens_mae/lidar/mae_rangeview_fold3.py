# mae_rangeview_fold3.py  (generado desde mae_rangeview_pretrain.py = fold 0) — Pré-treino MAE sobre a RANGE-VIEW (track range-view).
...
# Fold 3: las MISMAS 8 escenas de train que f1cv_mae_fold3.py. Las 2 escenas
# retenidas de este fold (367b072edc9822ea, 4a2ef30000d19d90) NO estan aca:
