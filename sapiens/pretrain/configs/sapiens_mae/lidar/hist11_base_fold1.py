# hist11_base_fold1.py — el baseline cinemático con la historia COMPLETA.
#
# Copia de noclip_base_fold1.py con history_len 5 -> 11. Es el único
...
# GENERADO por run_noclip_cv.sh — base del fold 1, protocolo VIGENTE.
# Igual a f1cv_base_fold1 pero SIN el recorte del objetivo (clip_norm=None) y con
...
work_dir = './work_dirs/noclipcv/noclip_base_fold1'
