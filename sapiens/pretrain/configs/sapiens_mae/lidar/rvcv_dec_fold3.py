# GENERADO — decoder range-view, fold 0 (= split original de Fase 1).
# gate0 (control de arquitectura) y gated se eligen por --cfg-options.
# Encoder mae_encoder_rangeview.pth: pre-entrenado SOLO en las 8 de train
# -> sin fuga sobre 7e2f7278 / 82f90331.
# clean10_rv_gated_init.py — MOTF gated sobre RANGE-VIEW (track range-view).
...
train_scenes = [
    '2a81f5233075e987', '2e41fe6faf5cd2ea', '394e61f27c2a1700', '4014ae5bcda2726f',
    '41692b0ec7ff4123', '4b60f9400a30ceaf', '7e2f727866c69ea0', '82f90331a1dfe968',
]
...
load_from = './work_dirs/mae_rv_nativo/enc_fold3.pth'
