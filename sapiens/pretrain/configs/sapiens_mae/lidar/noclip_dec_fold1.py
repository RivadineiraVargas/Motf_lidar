# GENERADO por run_noclip_cv.sh — dec del fold 1, protocolo VIGENTE.
# Igual a f1cv_dec_fold1 pero SIN el recorte del objetivo (clip_norm=None) y con
...
work_dir = './work_dirs/noclipcv/noclip_dec_fold1'
