...
# Baseline MLP a 500 épocas — comparação JUSTA contra attn-gated (mesmas épocas,
# mesma normalização atual, mesmo lr). Histórico -> MLP, sem cena.
custom_imports = dict(
    imports=[
...
work_dir = './work_dirs/baseline_overfit_500'
