# mae_rangeview_fold2.py  (generado desde mae_rangeview_pretrain.py = fold 0) — Pré-treino MAE sobre a RANGE-VIEW (track range-view).
...
# Fold 2: las MISMAS 8 escenas de train que f1cv_mae_fold2.py. Las 2 escenas
# retenidas de este fold (2e41fe6faf5cd2ea, 41692b0ec7ff4123) NO estan aca:
