# GENERADO — geo_dec_fold0: identico a noclip_dec_fold0 pero con el encoder GEOMETRICO.
...
work_dir = './work_dirs/geo/geo_dec_fold0'
load_from = './work_dirs/geo/mae_encoder_fold0.pth'
