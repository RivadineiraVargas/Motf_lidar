# GENERADO por run_noclip_cv.sh — base del fold 2, protocolo VIGENTE.
...
# GENERADO por run_fase1_cv.sh — decoder (base) del fold 2.
...
work_dir = './work_dirs/noclipcv/noclip_base_fold2'
