# GENERADO — encoder del fold 0 con objetivo GEOMETRICO (centroide) y 7
# ventanas por escena (56 muestras en vez de 8). Todo lo demas identico a
# f1cv_mae_fold0.py para que la comparacion sea limpia.
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=[],
        geo_target=True,     # objetivo GeoMAE: centroide por vóxel
        max_windows=7,       # 7 ventanas por escena: 8 -> 56 muestras
        scenes=[
            '2a81f5233075e987',
            '2e41fe6faf5cd2ea',
            '367b072edc9822ea',
...
work_dir   = './work_dirs/geo/mae_fold0'
