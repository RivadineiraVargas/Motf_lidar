# config_rangeview_rect_fold0.py — Re-pre-entrenamiento del encoder MAE SOLO
# en las 20 escenas de TRAIN del fold 0 (sin fuga de las 5 retenidas), para
# testear la hipótesis "encoder adaptado al dominio > encoder genérico
# congelado" (ingrediente de la Fase 1). Datos: 100 PNG (20 escenas x 5
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CustomDataset',
        data_root='/home/lcad/lidar_sweep_viewer/waymo_clean/range_png_rect/fold0_train',
        with_label=False,
...
work_dir = './work_dirs/rv_rect_fold0'
