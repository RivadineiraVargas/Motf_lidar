# mae_rangeview_fold1.py  (generado desde mae_rangeview_pretrain.py = fold 0) — Pré-treino MAE sobre a RANGE-VIEW (track range-view).
...
# Fold 1: las MISMAS 8 escenas de train que f1cv_mae_fold1.py. Las 2 escenas
# retenidas de este fold (2a81f5233075e987, 4014ae5bcda2726f) NO estan aca:
