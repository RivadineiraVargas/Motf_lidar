# config_rangeview_rect_fold4.py — Re-pre-entrenamiento del encoder MAE SOLO
# en las 20 escenas de TRAIN del fold 4 (sin fuga de las 5 retenidas), para
# testear si el efecto medido en el fold 0 (escena -20.4% a 3s, p=0.0006 con
# 8 semillas) GENERALIZA a otro split de escenas. La varianza entre folds era
# la dominante (sd 0.326 vs 0.089 entre semillas), asi que un solo fold no
# alcanza. Se elige el fold 4 por ser el caso ADVERSARIAL: con el encoder
# generico era el peor de los cinco (diff +0.834, la escena danaba 3/3
# semillas). Si el encoder de dominio lo da vuelta aca, el efecto es robusto.
...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CustomDataset',
        data_root='/home/lcad/lidar_sweep_viewer/waymo_clean/range_png_rect/fold4_train',
        with_label=False,
...
work_dir = './work_dirs/rv_rect_fold4'
