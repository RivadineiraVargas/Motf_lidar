# trajectory_attn_multiescena.py
# Experimento multi-cena (10 cenas): treina em 8, valida em 2 retidas.
# Objetivo: ver se o gate ABRE (modelo usa a cena) e se atenção > baseline
# quando há variação de cenário — o teste REAL da hipótese.
...
# Split por cena (2 retidas p/ validação, com objetos suficientes)
...
work_dir = './work_dirs/trajectory_attn_multiescena'
