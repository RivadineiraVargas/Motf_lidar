...
checkpoint_path = 'work_dirs/trajectory_overfit_v2_mlp/epoch_200.pth'  # Ajusta si es necesario
...
ade_list = []
fde_list = []
os.makedirs('eval_step2', exist_ok=True)
...
for idx in range(len(dataset)):
    ...
    plt.savefig(f'eval_step2/obj_{idx}.png')
    plt.close()
