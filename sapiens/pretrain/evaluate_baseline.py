...
# Configuración
cfg = Config.fromfile('configs/sapiens_mae/lidar/baseline_overfit.py')
model_args = {k: v for k, v in cfg.model.items() if k != 'type'}
model = BaselineTrajectoryModel(**model_args)
checkpoint_path = 'work_dirs/baseline_overfit_norm/epoch_200.pth'
